...
export class initialMigration1712174084029 implements MigrationInterface {
    name = 'initialMigration1712174084029'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` int NOT NULL AUTO_INCREMENT, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`refreshToken\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
